...
function ResultsFormListingsTabContent(props) {
            ...
            <OuterWrapper>
                        ...
                        <AutoSizer>
                            {({height, width}) => (
                                <FixedSizeList height={height} width={width} itemSize={170}
                                               itemCount={Object.values(results).length}
                                               itemData={{results: Object.values(results), isOpen: isOpen, selectRowIndex: selectRowIndex}}
                                >
                                    {renderRow}
                                </FixedSizeList>
                            )}
                ...
                <SidebarContainer isOpen={isOpen}>
                    ...
                    <StyledMapContainer isOpen={isOpen}>
                        <ListingsMap results={results} selectedRowIndex={selectedRowIndex}/>
                    </StyledMapContainer>
                </SidebarContainer>
            </OuterWrapper>
        </React.Fragment>
...
export default connect(mapStateToProps)(ResultsFormListingsTabContent);
